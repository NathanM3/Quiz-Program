"""Based on 10_Assembled_Outcome_v3.py
Adding Dismiss button (line 519)
Adding a score update to the Quiz GUI (lines 561-572)
Rephrasing Questions to be simpler (lines 460, 495)
Nathan Morrison
7/09/2021
"""
...
class Menu:
    def __init__(self):
        ...
        self.countries_button = Button(self.buttons_frame, text="Countries",
                                       ...
                                       bg="blue", fg="snow",
                                       command=lambda: self.quiz("country", "capital"))
        ...
        self.capitals_button = Button(self.buttons_frame, text="Capitals",
                                      ...
                                      bg="forest green",
                                      fg="snow", command=
                                      lambda: self.quiz("capital", "country"))
    ...
    def name_check(self):
        ...
        while True:  # Loop does not end
            name = str(self.get_name_entry.get())  # Takes from entry box
            try:
                for letter in name:
    ...
    def __init__(self, partner, answers):
        ...
        self.history_text = Label(self.history_frame,
                                  text="Here are your most recent "
                                       "answers. Please use the export "
                                       "button to create a text file of all "
                                       "your answers for this session",
...
class Quiz:
        ...
        if location_find:
            ...
            if self.main_dict.get(location_find) == self.key_value:
                ...
                answer = f"'{location_find}' is the {self.mode} of " \
                         ...
                         f"answer(s) | {partner.incorrect} incorrect answer(s)"
    ...
    def next_command(self, mode):
        ...
        self.question_label.configure(
            text=f"What {self.mode} matches with this {self.anti_mode}?:\n"
