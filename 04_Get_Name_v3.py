"""Based on 04_Get_Name_v2.py
This version is looking at disabling the 'countries' and 'capitals' buttons
while the pop up window is opened. Both buttons need to be disabled
when either window is open.
The partner module from functools was used to disable any buttons in the
main menu from any class. Used at lines (193-203)
"""
