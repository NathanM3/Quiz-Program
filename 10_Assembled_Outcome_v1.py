"""Based on 09_Export_GUI_v3.py
This is the first version of my assembled outcome.
Changes from 09 is going over everything and making sure there are enough
comments. Making changes to history class so that the user name is removed
when the history GUI is closed
6/09/2021
"""
...
class Menu:
    def __init__(self):
        ...
        self.all_answers = []
        self.user_name = ""  # self.user_name can be called throughout menu
    ...
    def history(self):
        self.all_answers.insert(0, self.user_name)  # username is now in list
...
class History:
    ...
    def close_history(self, partner):
        ...
        partner.all_answers.remove(partner.user_name)
        print(partner.all_answers)
