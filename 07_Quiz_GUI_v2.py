"""Based on 07_Quiz_GUI_v1.py
This improves upon this version by modifying the functions in the Quiz class
One of the key changes I made was adding self to variables within the class.
This means that I can call variables outside of the function without
unnecessary code. Other changes to functions were changing button states and
text colours for right and wrong answers. The program now says whether an
answer is right or wrong (I combined several functions together to not waste
lines. 31/08/2021
"""
