"""Adding the name checking function to my program.
This meant that new functions had to be created for the buttons to function
lines 65 and 72, and lines 95-127
The name checking function was modified slightly to work better with the GUI
I also created the Capitals and Countries classes that will be used to open the
pop up windows. Lines 187-194"""
