"""Based on 09_Export_GUI_v1.py
Changing small details before working on and testing my assembled outcome
Modified username to become a self variable that can be sent to history
Username is put into the answers list and is at the top of the export file.
"""
...
class Menu:
    def __init__(self):
        ...
        self.all_answers = []
        self.user_name = ""  # creating the variable to refer to later
    ...
    def history(self):
        self.all_answers.insert(0, self.user_name)
